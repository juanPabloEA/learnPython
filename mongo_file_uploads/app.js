...
const mongoUtils = require('./config/mongo');
...
app.get('/', (req, res) => {
  ...
  exercise.find({}).then((data, err) => {console.log(data);console.log(err);
  });

  // Exercise.findById('5af96c693fd35416ec441b6a')
  //   .exec()
  //   .then(function(exer) {
  //     console.log('exer')
  //     console.log(exer)
